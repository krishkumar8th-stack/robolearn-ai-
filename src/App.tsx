      ...
      <AuthProvider>
        <ThemeProvider>
          <LanguageProvider>
            <SimulationProvider>
              <AppErrorBoundary>
                <div className="flex min-h-screen flex-col bg-slate-50 text-slate-900 transition-colors duration-200 dark:bg-[#070b14] dark:text-slate-100 selection:bg-cyan-500/20 selection:text-cyan-700 dark:selection:text-cyan-300">
                  <Navbar />
